<template>
  <div
    class="oda-menu-bar"
    style="position: absolute; height: 31px; left: 0px; top: 34px; right: 0px;"
  >
    <div
      id="q2"
      class="oda-mbar-cont"
    >
      <div
        id="q4"
        class="basic fakehbox aligncenter menubar"
        style="padding : 0 5px 0 50px;position:static"
      >
        <b-dropdown
          id="ddown1"
          no-caret
        ...
        >
          ...
          <b-dropdown-item @click="uploadFile()">
            Upload File <i class="menu-icon fa fa-upload" />
          </b-dropdown-item>
        ...
        >
          ...
          <b-dropdown-item @click="gotoAddresss">
            Goto Address <span class="menu-icon">(ctrl-g)</span>
          </b-dropdown-item>
          <b-dropdown-item @click="findBytes">
            Find Sequence Of Bytes <span class="menu-icon">(ctrl-f)</span>
          </b-dropdown-item>
        </b-dropdown>
        <b-dropdown
          id="ddown1"
        ...
        >
          ...
          <b-dropdown-item @click="showSymbols">
            Symbols
          </b-dropdown-item>
          <b-dropdown-item @click="showStrings">
            Strings
          </b-dropdown-item>
          <b-dropdown-item @click="showDecompiler">
            Decompiler
          </b-dropdown-item>
        </b-dropdown>
        <b-dropdown
        ...
        >
          ...
          <b-dropdown-item v-b-modal="'whats-oda'">
            What's ODA?
          </b-dropdown-item>
          <b-dropdown-item>Tutorial</b-dropdown-item>
          <b-dropdown-item v-b-modal="'about-oda'">
            About
          </b-dropdown-item>
        </b-dropdown>
      </div>
    ...
    >
      <div>
        ...
        <p /><p>
          ...
          See the <a href="http://blog.onlinedisassembler.com/blog/?p=44">tutorial</a> for an overview of <b>ODA</b>'s features.
        </p><p /><p>
          <b>ODA</b> is a BETA release that is limited by the resource constraints of the server on which it is
        ...
        </p><h4>Supported Architectures</h4>
...
<style scoped>
  ...
  ::v-deep.dropdown .dropdown-menu .dropdown-item:focus {
    outline: none;
  }
